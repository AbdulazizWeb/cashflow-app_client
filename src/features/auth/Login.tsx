      ...
      >
        ...
        >
          <Card className="overflow-hidden p-0 border-0   ">
            <CardContent className="grid p-0 md:grid-cols-2  h-[65vh]">
              <form
                autoComplete="off"
                className="p-6 md:p-8"
                onSubmit={handleSubmit(onSubmit)}
              >
                <FieldGroup className="h-[65vh]">
                  <div className="flex flex-col items-center gap-2 text-center ">
                    <h1 className="text-2xl font-bold">Welcome back</h1>
                    <p className="text-muted-foreground text-balance">
                      Login to your Cashflow-app account
                    </p>
                  </div>

                  <Field className="h-[50%]">
              ...
              <div className="bg-muted relative hidden md:block">
                <img
                  src="/src/shared/assets/loginBg.jpeg"
                  alt="Image"
